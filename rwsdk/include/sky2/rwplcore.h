...
/*************************************************************************
 *
 * Filename: <C:/daily/rwsdk/include/sky2/rwplcore.h>
...
/* Metrowerks do not yet support this so guard */
#if (!defined(__MWERKS__))
...
#if ( (!defined(RWSUPPRESSOPTIMIZATIONPRAGMAS)) && (defined(__MWERKS__)) )
...
#endif /* ( (!defined(RWSUPPRESSOPTIMIZATIONPRAGMAS)) && defined(__MWERKS__)) ) */
...
/*--- Automatically derived from: C:/daily/rwsdk/os/sky/osintf.h ---*/
