...
struct RtGCondPolygon
{
    ...
    RwInt16 matIndex;   /**< The material index */
...
extern void RtGCondSetGeometryConditioningPipeline(RtGCondGeometryConditioningPipeline pipeline);
extern RtGCondGeometryConditioningPipeline RtGCondGetGeometryConditioningPipeline( void );
...
extern void RtGCondSnapUVsPipelineNode(RtGCondGeometryList *geometryList, RwReal weldThreshold);
extern void RtGCondCullZeroAreaPolygonsPipelineNode(RtGCondGeometryList *geometryList, RwReal areaThreshold);
extern void RtGCondLimitUVsPipelineNode(RtGCondGeometryList * geometryList, RwReal limitUVMin, RwReal limitUVMax);
extern void RtGCondRemapVerticesPipelineNode(RtGCondGeometryList * geometryList);
extern void RtGCondUnshareVerticesOnMaterialBoundariesPipelineNode(RtGCondGeometryList* geometryList);
...
extern RwInt32* RtGCondWeldVerticesPipelineNode(RtGCondGeometryList *geometryList, RwReal weldThreshold,
                    RwReal normalWeldThreshold, RwReal uvThreshold, RwReal preLitThreshold,
                    RwBool ignoreTextures, RwBool remap, RwBool implicit, RwBool averageAttributes);
...
extern RtGCondParameters* RtGCondParametersGet(void);
