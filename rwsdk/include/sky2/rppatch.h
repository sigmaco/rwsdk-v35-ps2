...
/*---- start: ./sky2/patchplatform.h----*/

/**
 * \defgroup rppatchsky PlayStation 2
 * \ingroup rppatch
 *
...
/**
 * \ingroup rppatchsky
 * \ref RpPatchSkyPipeline rendering pipelines available within the
 * RpPatch plugin. Use \ref RpPatchGetSkyPipeline to retrieve
 * the \ref RxPipeline s.
 */
enum RpPatchSkyPipeline
{
    rpNAPATCHSKYPIPELINE                     = 0,
    rpPATCHSKYGENERICPS2ALLPIPELINE          = 1,
    /**<PS2All generic patch rendering pipeline.          */
    rpPATCHSKYMATFXPS2ALLPIPELINE            = 2,
    /**<PS2All material effect (single set of
        texture coordinates) patch rendering pipeline.     */
    rpPATCHSKYMATFXUV2PS2ALLPIPELINE         = 3,
    /**<PS2All material effect (double set of
        texture coordinates) patch rendering pipeline.     */
    rpPATCHSKYSKINPS2ALLPIPELINE             = 4,
    /**<PS2All skinned patch rendering pipeline.          */
    rpPATCHSKYSKINMATFXPS2ALLPIPELINE        = 5,
    /**<PS2All skinned material effect (single set of
        texture coordinates) patch rendering pipeline.     */
    rpPATCHSKYSKINMATFXUV2PS2ALLPIPELINE     = 6,
    /**<PS2All skinned material effect (double set of
        texture coordinates) patch rendering pipeline.     */
    rpPATCHSKYGENERICPS2ALLMATPIPELINE       = 7,
    /**<PS2AllMat generic patch rendering pipeline. */
    rpPATCHSKYMATFXPS2ALLMATPIPELINE         = 8,
    /**<PS2AllMat material effect (single set of
        texture coordinates) patch rendering pipeline.     */
    rpPATCHSKYMATFXUV2PS2ALLMATPIPELINE      = 9,
    /**<PS2AllMat material effect (double set of
        texture coordinates) patch rendering pipeline.     */
    rpPATCHSKYSKINPS2ALLMATPIPELINE          = 10,
    /**<PS2AllMat skinned patch rendering pipeline. */
    rpPATCHSKYSKINMATFXPS2ALLMATPIPELINE     = 11,
    /**<PS2AllMat skinned material effect (single set
        of texture coordinates) patch rendering pipeline.  */
    rpPATCHSKYSKINMATFXUV2PS2ALLMATPIPELINE  = 12,
    /**<PS2AllMat skinned material effect (double set
        of texture coordinates) patch rendering pipeline.  */
    rpPATCHSKYPIPELINEMAX,
    rpPATCHSKYPIPELINEFORCEENUMSIZEINT = RWFORCEENUMSIZEINT
};
typedef enum RpPatchSkyPipeline RpPatchSkyPipeline;
...
extern RxPipeline *
RpPatchGetSkyPipeline( RpPatchSkyPipeline ps2Pipeline );

#ifdef __cplusplus
}
#endif /* __cplusplus */

/*---- end: ./sky2/patchplatform.h----*/
