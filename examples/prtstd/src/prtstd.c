...
#ifdef SIZEANIM
    PrtData.emtPtrSize->prtStartSize.x = 0.0f;
    PrtData.emtPtrSize->prtStartSize.y = 0.0f;
    PrtData.emtPtrSize->prtStartSizeBias.x = 0.0f;
    PrtData.emtPtrSize->prtStartSizeBias.y = 0.0f;
    PrtData.emtPtrSize->prtEndSize.x = 1.0f;
    PrtData.emtPtrSize->prtEndSize.y = 1.0f;
    PrtData.emtPtrSize->prtEndSizeBias.x = 0.0f;
    PrtData.emtPtrSize->prtEndSizeBias.y = 0.0f;
#endif
...
PrtStdInitialize(void)
{
    ...
    PrtData.emtPtrSize = (RpPrtStdEmitterPrtSize *) (((RwChar *)PrtData.emitter) + offset);
#endif
