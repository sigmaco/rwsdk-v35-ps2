...
InitializeMenu(void)
{    
    static RwChar animTypeLabel[] = RWSTRING("Animation Type");
    static const RwChar *animTypeStrings[] = 
    {
        RWSTRING("compressed"),
    ...
    {
        MenuAddEntryInt(animTypeLabel, &AnimTypeIndex, 
            AnimTypeCallback, 0, 1, 1, animTypeStrings);
...
DisplayOnScreenInfo(void)
{
    ...
    if (AnimTypeIndex == 0)
    {
        animSize = CompressedAnimSize / 1024.0f;
    }
    else
    {
        animSize = UncompressedAnimSize / 1024.0f;
    }
