...
AtomicAddVertices(RpAtomic *atomic, void *data)
{
     ...
     */
    vertsOut = (RwV3d *)RwMalloc(numVerts * sizeof(RwV3d));
...
AtomicAddBoundingSphere(RpAtomic *atomic, void *data)
{
    ...
    RwV3dTransformPoints(&atomicSphere.center, 
        &atomicSphere.center, 1, &transform);
...
ClumpCalculateWorldBoundingSphere(RpClump *clump)
{
    ...
    RwV3dTransformPoints(&ClumpWorldBoundingSphere.center, 
        &ClumpLocalBoundingSphere.center, 1, ltm);
