...
CFG=camera - Win32 PS2 EE Release
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "camera_sky2.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "camera_sky2.mak" CFG="camera - Win32 PS2 EE Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "camera - Win32 PS2 EE Release" (based on "Win32 (x86) Application")
!MESSAGE "camera - Win32 PS2 EE Debug" (based on "Win32 (x86) Application")
!MESSAGE "camera - Win32 PS2 EE Metrics" (based on "Win32 (x86) Application")
!MESSAGE 

# Begin Project
# PROP AllowPerConfigDependencies 0
# PROP Scc_ProjName "camera_sky2"
# PROP Scc_LocalPath "..\.."
CPP=snCl.exe
MTL=midl.exe
RSC=rc.exe

!IF  "$(CFG)" == "camera - Win32 PS2 EE Release"
...
# ADD LINK32 librppds.a librtcharse.a librtpng.a librtbmp.a librpworld.a librwcore.a librplogo.a libgraph.a libdma.a libdev.a libpad.a libpkt.a libvu0.a /nologo /pdb:none /machine:IX86 /out:"./camera_sky2.elf" /libpath:"../../rwsdk/lib/sky2/release" /D:SN_TARGET_PS2
# SUBTRACT LINK32 /debug

!ELSEIF  "$(CFG)" == "camera - Win32 PS2 EE Debug"
...
# ADD LINK32 librppds.a librtcharse.a librtpng.a librtbmp.a librpworld.a librwcore.a librplogo.a libgraph.a libdma.a libdev.a libpad.a libpkt.a libvu0.a /nologo /subsystem:windows /pdb:none /debug /machine:IX86 /out:"./camera_sky2d.elf" /libpath:"../../rwsdk/lib/sky2/debug" /D:SN_TARGET_PS2

!ELSEIF  "$(CFG)" == "camera - Win32 PS2 EE Metrics"
...
LINK32=snLink.exe
# ADD BASE LINK32 libgraph.a libdma.a libdev.a libpad.a libpkt.a libvu0.a /nologo /subsystem:windows /machine:IX86
# ADD LINK32 librppds.a librtcharse.a librtpng.a librtbmp.a librpworld.a librwcore.a librplogo.a libgraph.a libdma.a libdev.a libpad.a libpkt.a libvu0.a /nologo /pdb:none /machine:IX86 /out:"./camera_sky2m.elf" /libpath:"../../rwsdk/lib/sky2/metrics" /D:SN_TARGET_PS2

!ENDIF 

# Begin Target

# Name "camera - Win32 PS2 EE Release"
# Name "camera - Win32 PS2 EE Debug"
# Name "camera - Win32 PS2 EE Metrics"
