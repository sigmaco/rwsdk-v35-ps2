...
static Rt2dMaestro *
RestartMaestroAnim(Rt2dMaestro *maestro,
                   Rt2dAnim *anim,
                   Rt2dAnimProps *props,
...
static RwBool
MaestroRestartCB(RwBool justCheck)
{
    Rt2dMessage     message;
    ...
    if (Maestro)
    {
        ...
        Rt2dMaestroForAllVisibleAnimations(Maestro, RestartMaestroAnim, 0);
    }
...
MaestroMenuCreate(void)
{
    ...
    static RwChar MaestroRestartLabel[32];
    ...
    rwstrcpy(MaestroRestartLabel, RWSTRING("Restart Maestro_A"));
    ...
    MenuAddEntryTrigger(MaestroRestartLabel, MaestroRestartCB);
...
MaestroMenuDestroy(void)
{
    ...
    MenuRemoveEntry(MaestroRestartCB);
